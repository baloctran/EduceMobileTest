...
const columnOfTwoResponses = (response1, response2, key) =>
  <Row key={key}>
    ...
    {key < 2 && <Col style={styles.matColLine}>
    ...
    {/* {key ===2 && <Col style={styles.matColLine}>
      <View style={styles.matLine2} ></View>
      <View style={styles.matLine3} ></View>
    </Col>
...
export default class Matrix5 extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      tablet: false
              ...
              <View style={this.state.tablet ? styles.matrixViewTablet : styles.matrixViewMobile}>
                ...
                <Grid style={{ flexDirection: 'row', position: 'relative' }} >
                  {matrixResponse.map((response, rKey) => {
                    if (rKey % 2 === 0 && matrixResponse[rKey + 1]) return columnOfTwoResponses(response, matrixResponse[rKey + 1], rKey) 
                  })
                  }
                </Grid>
                }
