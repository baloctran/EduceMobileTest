  ...
  <Row key={key}>
    <Col style={styles.matColVal} >
      <Text style={styles.matVals}>{response1.response} <Text style={styles.indicator}>{response1.indicator.text}
        <Text style={{ fontSize: 14 * 1.6, color: 'rgba(0,0,0,0.54)',fontWeight: 'normal', lineHeight: 22 * 1.1, textAlignVertical: 'top' }}>
      ...
      <Text style={styles.matVals3}>{response2.response} <Text style={styles.indicator}>{response2.indicator.text}
        <Text style={{ fontSize: 7 * 1.6, color: 'rgba(0,0,0,0.54)', lineHeight: 18 * 1.1, textAlignVertical: response2.indicator.sup ? 'top' : 'bottom' }}>
    ...
    {key < 4 && <Col style={styles.matColLine}>
...
export default class Matrix6 extends React.Component {
