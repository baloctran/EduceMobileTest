  ...
  <Row key={key}>
    <Col style={styles.matColVal} >
      ...
      <Text style={styles.matVals}>{response2.response} <Text style={styles.indicator}>{response2.indicator.text}
        <Text style={{ fontSize: 7 * 1.6, color: 'rgba(0,0,0,0.54)', lineHeight: 22 * 1.1, textAlignVertical: response2.indicator.sup ? 'top' : 'bottom' }}>
...
export default class Matrix1 extends React.Component {
